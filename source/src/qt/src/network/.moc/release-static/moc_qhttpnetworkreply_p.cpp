...
**
** Created: Mon Sep 16 14:51:05 2013
...
static const char qt_meta_stringdata_QHttpNetworkReply[] = {
    "QHttpNetworkReply\0sslErrors(QList<QSslError>)\0"
    "errors\0\0readyRead()\0finished()\0"
    "finishedWithError(QNetworkReply::NetworkError,QString)\0"
    "errorCode,detail\0"
    "finishedWithError(QNetworkReply::NetworkError)\0"
    "errorCode\0headerChanged()\0"
    "dataReadProgress(int,int)\0done,total\0"
