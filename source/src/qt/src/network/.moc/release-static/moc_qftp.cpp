...
**
** Created: Mon Sep 16 14:45:17 2013
...
static const char qt_meta_stringdata_QFtp[] = {
    "QFtp\0stateChanged(int)\0\0listInfo(QUrlInfo)\0"
    "readyRead()\0dataTransferProgress(qint64,qint64)\0"
    ",\0rawCommandReply(int,QString)\0"
