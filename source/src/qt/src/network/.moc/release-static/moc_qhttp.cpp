...
**
** Created: Mon Sep 16 14:45:30 2013
...
static const char qt_meta_stringdata_QHttp[] = {
    "QHttp\0stateChanged(int)\0\0"
    "responseHeaderReceived(QHttpResponseHeader)\0"
    "resp\0readyRead(QHttpResponseHeader)\0"
    ...
    "proxy,\0authenticationRequired(QString,quint16,QAuthenticator*)\0"
    "hostname,port,\0sslErrors(QList<QSslError>)\0"
    "errors\0abort()\0ignoreSslErrors()\0"
    "_q_startNextRequest()\0_q_slotReadyRead()\0"
    "_q_slotConnected()\0"
    "_q_slotError(QAbstractSocket::SocketError)\0"
    "_q_slotClosed()\0_q_slotBytesWritten(qint64)\0"
    "numBytes\0_q_slotEncryptedBytesWritten(qint64)\0"
