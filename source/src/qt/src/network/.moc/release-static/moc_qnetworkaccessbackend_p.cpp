...
**
** Created: Mon Sep 16 14:51:08 2013
...
static const char qt_meta_stringdata_QNetworkAccessBackend[] = {
    "QNetworkAccessBackend\0"
    "writeDownstreamData(QIODevice*)\0data\0"
    "\0finished()\0error(QNetworkReply::NetworkError,QString)\0"
    "code,errorString\0"
    "proxyAuthenticationRequired(QNetworkProxy,QAuthenticator*)\0"
    "proxy,auth\0authenticationRequired(QAuthenticator*)\0"
    "auth\0metaDataChanged()\0"
    "redirectionRequested(QUrl)\0destination\0"
    "sslErrors(QList<QSslError>)\0errors\0"
