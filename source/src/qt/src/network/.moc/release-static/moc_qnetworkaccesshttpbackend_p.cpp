...
**
** Created: Mon Sep 16 14:51:10 2013
...
static const char qt_meta_stringdata_QNetworkAccessHttpBackend[] = {
    "QNetworkAccessHttpBackend\0startHttpRequest()\0"
    "\0abortHttpRequest()\0readBufferSizeChanged(qint64)\0"
    ...
    ",\0httpAuthenticationRequired(QHttpNetworkRequest,QAuthenticator*)\0"
    "request,auth\0"
    "httpError(QNetworkReply::NetworkError,QString)\0"
    "error,errorString\0"
    "replySslErrors(QList<QSslError>,bool*,QList<QSslError>*)\0"
    ",,\0replySslConfigurationChanged(QSslConfiguration)\0"
    "resetUploadDataSlot(bool*)\0r\0"
    "wantUploadDataSlot(qint64)\0"
    "sentUploadDataSlot(qint64)\0"
    "sendCacheContents(QNetworkCacheMetaData)\0"
    "metaData\0bool\0"
};
