...
**
** Created: Mon Sep 16 14:46:05 2013
...
static const char qt_meta_stringdata_QHttpNetworkConnectionChannel[] = {
    ...
    "_q_receiveReply()\0\0_q_bytesWritten(qint64)\0"
    "bytes\0_q_readyRead()\0_q_disconnected()\0"
    "_q_connected()\0_q_error(QAbstractSocket::SocketError)\0"
    "_q_proxyAuthenticationRequired(QNetworkProxy,QAuthenticator*)\0"
    "proxy,auth\0_q_uploadDataReadyRead()\0"
    "_q_encrypted()\0_q_sslErrors(QList<QSslError>)\0"
    "errors\0_q_encryptedBytesWritten(qint64)\0"
};
