...
**
** Created: Mon Sep 16 14:46:18 2013
...
static const uint qt_meta_data_QNetworkAccessManager[] = {
 ...
 // signals: signature, parameters, type, tag, flags
      22,   81,  101,  101, 0x05,
     102,  157,  101,  101, 0x05,
     177,  202,  101,  101, 0x05,
     208,  251,  101,  101, 0x05,
     264,  101,  101,  101, 0x05,
     290,  360,  101,  101, 0x05,

 // slots: signature, parameters, type, tag, flags
     371,  101,  101,  101, 0x08,
     390,  101,  101,  101, 0x08,
     426,  101,  101,  101, 0x08,
     452,  101,  101,  101, 0x08,
...
static const char qt_meta_stringdata_QNetworkAccessManager[] = {
    ...
    "proxy,authenticator\0\0"
    "authenticationRequired(QNetworkReply*,QAuthenticator*)\0"
    "reply,authenticator\0finished(QNetworkReply*)\0"
    "reply\0sslErrors(QNetworkReply*,QList<QSslError>)\0"
    "reply,errors\0networkSessionConnected()\0"
    "networkAccessibleChanged(QNetworkAccessManager::NetworkAccessibility)\0"
    "accessible\0_q_replyFinished()\0"
