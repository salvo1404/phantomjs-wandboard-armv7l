...
**
** Created: Mon Sep 16 14:50:32 2013
...
static const char qt_meta_stringdata_QSslSocket[] = {
    "QSslSocket\0encrypted()\0\0"
    "peerVerifyError(QSslError)\0error\0"
    "sslErrors(QList<QSslError>)\0errors\0"
    "modeChanged(QSslSocket::SslMode)\0"
    "newMode\0encryptedBytesWritten(qint64)\0"
    "totalBytes\0startClientEncryption()\0"
