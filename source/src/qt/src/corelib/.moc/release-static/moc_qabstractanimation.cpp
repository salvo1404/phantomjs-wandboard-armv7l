...
**
** Created: Mon Sep 16 14:33:09 2013
...
static const char qt_meta_stringdata_QAbstractAnimation[] = {
    "QAbstractAnimation\0finished()\0\0"
    "stateChanged(QAbstractAnimation::State,QAbstractAnimation::State)\0"
    "newState,oldState\0currentLoopChanged(int)\0"
    "currentLoop\0directionChanged(QAbstractAnimation::Direction)\0"
    "start(QAbstractAnimation::DeletionPolicy)\0"
    "policy\0start()\0pause()\0resume()\0"
    "setPaused(bool)\0stop()\0setCurrentTime(int)\0"
    "msecs\0state\0State\0loopCount\0int\0"
    "currentTime\0direction\0Direction\0"
    "duration\0Forward\0Backward\0Stopped\0"
    "Paused\0Running\0"
};
