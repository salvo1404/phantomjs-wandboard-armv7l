...
**
** Created: Mon Sep 16 14:44:17 2013
...
static const char qt_meta_stringdata_QAbstractItemModel[] = {
    ...
    "orientation,first,last\0layoutChanged()\0"
    "layoutAboutToBeChanged()\0"
    "rowsAboutToBeInserted(QModelIndex,int,int)\0"
    "parent,first,last\0rowsInserted(QModelIndex,int,int)\0"
    ...
    "submit()\0bool\0revert()\0resetInternalData()\0"
};
