...
**
** Created: Mon Sep 16 14:43:56 2013
...
static const char qt_meta_stringdata_QFutureWatcherBase[] = {
    ...
    "canceled()\0paused()\0resumed()\0"
    "resultReadyAt(int)\0resultIndex\0"
    "resultsReadyAt(int,int)\0beginIndex,endIndex\0"
    "progressRangeChanged(int,int)\0"
    "minimum,maximum\0progressValueChanged(int)\0"
    "progressValue\0progressTextChanged(QString)\0"
    "progressText\0cancel()\0setPaused(bool)\0"
    "paused\0pause()\0resume()\0togglePaused()\0"
};
