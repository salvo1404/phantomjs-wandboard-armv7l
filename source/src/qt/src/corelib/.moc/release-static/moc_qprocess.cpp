...
**
** Created: Mon Sep 16 14:38:07 2013
...
static const char qt_meta_stringdata_QProcess[] = {
    "QProcess\0started()\0\0finished(int)\0"
    "exitCode\0finished(int,QProcess::ExitStatus)\0"
    "exitCode,exitStatus\0error(QProcess::ProcessError)\0"
    "error\0stateChanged(QProcess::ProcessState)\0"
    "state\0readyReadStandardOutput()\0"
    "readyReadStandardError()\0terminate()\0"
    "kill()\0_q_canReadStandardOutput()\0"
    "bool\0_q_canReadStandardError()\0"
    "_q_canWrite()\0_q_startupNotification()\0"
    "_q_processDied()\0_q_notified()\0"
};
