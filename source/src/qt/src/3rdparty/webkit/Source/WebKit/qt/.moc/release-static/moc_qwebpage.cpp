...
**
** Created: Mon Sep 16 21:08:31 2013
...
static const uint qt_meta_data_QWebPage[] = {
 ...
 // slots: signature, parameters, type, tag, flags
    1066,   23, 1094,   23, 0x0a,
    1099,   23,   23,   23, 0x08,
    1129, 1157,   23,   23, 0x08,
    1165,   23,   23,   23, 0x08,

 // properties: name, type, flags
    1190, 1094, 0x01095001,
    1199, 1212, 0x0a095001,
    1220, 1212, 0x0a095001,
    1233, 1094, 0x01095001,
    1246, 1259, 0x15095103,
    1265, 1259, 0x15095103,
    1287, 1094, 0x01095103,
    1313, 1334, 0x0009510b,
    1355, 1363, 0x44095103,
    1372, 1094, 0x01095103,
...
static const char qt_meta_stringdata_QWebPage[] = {
    "QWebPage\0loadStarted()\0\0loadProgress(int)\0"
    "progress\0loadFinished(bool)\0ok\0"
    "linkHovered(QString,QString,QString)\0"
    "link,title,textContent\0statusBarMessage(QString)\0"
    "text\0selectionChanged()\0"
    "frameCreated(QWebFrame*)\0frame\0"
    "geometryChangeRequested(QRect)\0geom\0"
    "repaintRequested(QRect)\0dirtyRect\0"
    "scrollRequested(int,int,QRect)\0"
    "dx,dy,scrollViewRect\0windowCloseRequested()\0"
    "printRequested(QWebFrame*)\0linkClicked(QUrl)\0"
    "url\0toolBarVisibilityChangeRequested(bool)\0"
    "visible\0statusBarVisibilityChangeRequested(bool)\0"
    "menuBarVisibilityChangeRequested(bool)\0"
    "unsupportedContent(QNetworkReply*)\0"
    "reply\0downloadRequested(QNetworkRequest)\0"
    "request\0microFocusChanged()\0"
    "contentsChanged()\0"
    ...
    "frame,item\0restoreFrameStateRequested(QWebFrame*)\0"
    "viewportChangeRequested()\0"
    "featurePermissionRequested(QWebFrame*,QWebPage::Feature)\0"
    "frame,feature\0"
    "featurePermissionRequestCanceled(QWebFrame*,QWebPage::Feature)\0"
    "shouldInterruptJavaScript()\0bool\0"
    "_q_onLoadProgressChanged(int)\0"
    "_q_webActionTriggered(bool)\0checked\0"
    "_q_cleanupLeakMessages()\0modified\0"
    "selectedText\0QString\0selectedHtml\0"
    "hasSelection\0viewportSize\0QSize\0"
    "preferredContentsSize\0forwardUnsupportedContent\0"
    "linkDelegationPolicy\0LinkDelegationPolicy\0"
    "palette\0QPalette\0contentEditable\0"
